...
<head>
    ...
    <style>
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 0.25rem rgba(217, 95, 140, 0.25);
            color: #ffffff !important;
        }
...
<body>
    ...
    <main class="min-vh-100">
        ...
        {{-- PERBAIKAN 1: Menambahkan @yield('content') agar halaman tidak kosong --}}
        @yield('content')
    </main>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-5 pt-0 text-center">
                    ...
                    <form action="{{ route('login.submit') }}" method="POST">
                        @csrf {{-- PENTING: Mencegah Error 419 --}}
    ...
    {{-- MODAL REGISTER (PERBAIKAN 2: Duplikasi Modal Dihapus, sisa satu saja di sini) --}}
                ...
                <div class="modal-body p-5 pt-0 text-center">
                    ...
                    <form action="{{ route('register.submit') }}" method="POST">
                        ...
                        <div class="mb-3 text-start">
                            <label class="form-label">USERNAME</label>
                            <input type="text" name="username" class="form-control"
                                placeholder="Pilih username unik" required value="{{ old('username') }}">
                        </div>
                        ...
                        <button type="submit" class="btn btn-gradient w-100 py-2 rounded-pill shadow-lg">
                            Daftar Sekarang
                        </button>
                    </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // PERBAIKAN 3: SCRIPT OTOMATIS BUKA MODAL YANG SUDAH DIBERSIHKAN DUPLIKASINYA
            @if(session('openLoginModal'))
                var loginModal = new bootstrap.Modal(document.getElementById('loginModal'));
                loginModal.show();
            @endif

            @if($errors->has('token') || $errors->has('username') && request()->is('register'))
