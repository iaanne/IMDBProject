...
@section('content')
    <style>
        ...
        :root {
            --bg-main: #0d0d0d;
            --bg-card: #141414;
            /* Ubah jadi abu gelap mewah (bukan hitam pekat) */
            --primary-pink: #d95f8c;
            --primary-red: #870339;
            --text-muted: #a3a3a3;
        ...
        .show-card-image {
            ...
            aspect-ratio: 2 / 3;
            height: auto;
            /* Biarkan tinggi menyesuaikan rasio */
            background: #222;
            position: relative;
            overflow: hidden;
        }
        ...
        .show-card:hover .show-card-image::after {
            left: 150%;
        }
        ...
        .show-card:hover .show-card-image i {
            color: var(--primary-pink);
            transform: scale(1.1);
        }
        ...
        .tmdb-poster {
            ...
            a.show-card {
                ...
                color: inherit;
                /* Mengikuti warna teks asli (putih) */
                display: flex;
                flex-direction: column;
            }
            ...
            a.show-card:hover .show-title {
                color: var(--primary-pink);
                /* Opsional: Ubah judul jadi pink saat hover agar lebih premium */
                text-decoration: none;
            }
            ...
            @forelse($mostWatchedShows as $show)
                ...
                <a href="{{ route('titles.show', $finalId) }}" class="show-card" style="text-decoration: none;">
                    <div class="show-card-image">
                        <img src="https://via.placeholder.com/300x450?text=Loading..." class="tmdb-poster"
                            alt="{{ $show->primaryTitle }}" data-id="{{ $finalId }}" data-type="tv">
                    </div>
        ...
        $('.tmdb-poster').each(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (imagePath) {
                        imgElement.attr('src', 'https://image.tmdb.org/t/p/w500' +
                            imagePath);
                    } else {
                        imgElement.attr('src',
                            'https://via.placeholder.com/300x450/1a1a1a/555555?text=No+Poster'
                            );
                    }
                }
            });
