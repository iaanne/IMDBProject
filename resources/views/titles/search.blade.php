...
@section('content')
    <style>
        ...
        .search-title {
            ...
            /* Mengubah warna judul pencarian menjadi putih */
        }

        .search-subtitle {
            font-size: 1.1rem;
            color: var(--text-white);
            /* Mengubah warna subtitle pencarian menjadi putih */
        }
        ...
        .result-card {
            ...
            color: var(--text-white);
            /* Mengubah warna teks default kartu menjadi putih */
        }
        ...
        .result-title {
            ...
            margin-bottom: 12px;
            color: var(--text-white);
            /* Memastikan judul hasil berwarna putih */
        }
        ...
        /* Menambahkan style untuk informasi tahun */
        .year-info {
            color: var(--text-white) !important;
            /* Memastikan informasi tahun berwarna putih */
        }

        /* Style untuk pesan "tidak ada hasil" */
        .no-results {
            color: var(--text-white) !important;
            /* Memastikan pesan "tidak ada hasil" berwarna putih */
        }

        /* Style untuk link kembali ke beranda */
        .back-home {
            color: var(--primary-pink) !important;
            /* Memastikan link kembali berwarna pink */
            text-decoration: none;
        ...
        .back-home:hover {
            ...
            /* Mengubah warna link saat hover menjadi putih */
    ...
    <div class="container pb-5">
        ...
        @else
            <div class="text-center py-5">
                ...
                <h3 class="no-results">Oops, tidak ada hasil.</h3>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            resultCards.forEach(card => {
                ...
                if (tconst && tconst.startsWith('tt')) {
                    const url =
                        `https://api.themoviedb.org/3/find/${tconst}?api_key=${apiKey}&external_source=imdb_id`;

                    fetch(url)
                        .then(res => res.json())
                        .then(data => {
                            const result = data.movie_results[0] || data.tv_results[0] || data
